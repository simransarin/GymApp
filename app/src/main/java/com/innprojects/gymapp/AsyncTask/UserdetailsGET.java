...
public class UserdetailsGET extends AsyncTask<String, Void, User> {
    ...
    private User parseJson(String json) {
        ...
        try {
            ...
            String date_of_birth = finalObject.getString("date_of_birth");
            int age = finalObject.getInt("age");
            String sex = finalObject.getString("sex");
            int height = finalObject.getInt("height");
            ...
            outputUser = new User(registration_number, name, address, phone_number, date_of_birth, age, sex, height, flag, username, email, id);
            Log.i("Log_BUSDownloadTask", outputUser.getDate_of_birth());
            return outputUser;
    ...
    protected void onPostExecute(User user) {
        if (user != null) {
            loginActivity.processResults(user);
        } else {
