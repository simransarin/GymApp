...
public class FlagPUTreset extends AsyncTask<String, Void, String> {
    ...
    public FlagPUTreset(SettingsActivity activity) {
        mActivity = activity;
    }
    ...
    protected void onPostExecute(String s) {
        if (s.equals("Exception: ") || s.equals("false : ") || s.equals(null))
            ...
            mActivity.processResultsFlagPUTreset();
    }
